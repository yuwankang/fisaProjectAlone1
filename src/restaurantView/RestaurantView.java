        ...
        while (true) {
            ...
            switch (option) {
                ...
                case 3:
                    ...
                    try {
                        RestaurantDTO recommendedRestaurant = controller.recommendByType(recommendType);
                ...
                case 4:
                    try {
                        ...
                        if (addPrice1 < 0) throw new IllegalArgumentException("메뉴 1의 가격은 음수일 수 없습니다.");
                        scanner.nextLine(); // 버퍼 비우기
                        ...
                        if (addPrice2 < 0) throw new IllegalArgumentException("메뉴 2의 가격은 음수일 수 없습니다.");
                        scanner.nextLine(); // 버퍼 비우기
                ...
                case 5:
                    try {
                        ...
                        if (newPrice1 < 0) throw new IllegalArgumentException("메뉴 1의 가격은 음수일 수 없습니다.");
                        scanner.nextLine(); // 버퍼 비우기
                        ...
                        if (newPrice2 < 0) throw new IllegalArgumentException("메뉴 2의 가격은 음수일 수 없습니다.");
                        scanner.nextLine(); // 버퍼 비우기
                ...
                case 6:
                    ...
                    controller.deleteRestaurant(deleteName);
                    break;
                case 7:
